<?php
	...
	$eleves = Eleves_inscrits::classe_eleves($id_class);
	//print_r($eleves);
?>
<!DOCTYPE html>
<html>
				...
				<tbody id="myTable">
					...
					?>
						<tr>
							...
							<td><?php echo $class." ".$eleve->designation;; ?></td>
							<!--td><a href="<?php echo $eleve->id; ?>">Voir</a></td-->
							<td><a href="../views/frais_paiement_eleve.php?id_eleve=<?php echo $eleve->id; ?>"> Voir</a></td>
						</tr>
					<?php 
						}
